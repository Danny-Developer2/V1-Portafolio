...
} from '../../services/get-experiences.service';
...
export class RegisterProjectComponent {
  ...
  constructor(
    ...
    private registerService: RegisterProjectsService,
    private getSkillsService: GetSkillsService,
    private getExperiencesService: GetExperiencesService,
  ...
  onSubmit() {
    ...
    try {
      ...
      console.error('Error al intentar registrar el proyecto:', error);
      this.toastr.error('Hubo un error al intentar registrar el proyecto.');
    }
  }
